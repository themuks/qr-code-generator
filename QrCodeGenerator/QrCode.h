...
public:
	bool EncodeData(char* lpsSource, int ncSource = 0);

private:
	int GetEncodeVersion(char* lpsSource, int ncLength);
	bool EncodeSourceData(char* lpsSource, int ncLength);
